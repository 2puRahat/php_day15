                    ...
                    <div class="card-body">
                        <form action="action.php" method="POST">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label bg-warning text-center">Password Lenth</label>
                                <div class="col-md-9">
                                    <input type="number" class="form-control" name="password_length"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label bg-info text-center">Your Password</label>
                                <div class="col-md-9">
